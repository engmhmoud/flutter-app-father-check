...
//     register(id, password) async {
//       var user = await _connection.query("select * from user where id=$id  ");

//       if (user.isEmpty) {
//         //  not   exixt then register (Add Data to User Table)
...
//     getdata(id) async {
//       var user =
//           (await _connection.query("select * from data where user_id=$id"))
//               .last;
//     }
//   }
// }
